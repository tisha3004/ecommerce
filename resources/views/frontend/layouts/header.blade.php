                    ...
                    <div class="right-content">
                        <ul class="list-main">
                            ...
                            @auth 
                                ...
                                @else 
                                <li><i class="fa fa-truck"></i> <a href="{{route('order.track')}}">Track Order</a></li>
                                <li><i class="fa fa-archive"></i> <a href="{{route('order.history')}}"> Order History</a></li>
                                <li><i class="fa fa-user"></i> <a href="{{route('edit')}}">Edit Profile</a></li>
                                ...
                                <div class="navbar-collapse">	
                                    <div class="nav-inner">	
                                        <ul class="nav main-menu menu navbar-nav">
                                            <li class="{{Request::path()=='home' ? 'active' : ''}}"><a href="{{route('home1')}}">Home</a></li>
