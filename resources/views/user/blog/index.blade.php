...
<div class="card shadow mb-4">
    ...
    <div class="container">
        <h2>List of Blogs</h2>
        <a href="{{ route('user.blog.add') }}" class="btn btn-primary btn-sm float-right" data-toggle="tooltip"
            data-placement="bottom" title="Add User"><i class="fas fa-plus"></i> Add More Blogs</a>

        <div class="table-responsive">
            <table class="table table-bordered table-hover" id="order-dataTable"  cellspacing="0">
                <thead>
                    <tr>
                        <th>ID</th>
                        <th>Title</th>
                ...
                <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        <form method="POST" action="{{ route('user.blog.delete', [$blog->id]) }}">
                                @csrf
                                @method('delete')
