...
<div class="card">
    ...
    <div class="card-body">
      <form method="post" action="{{route('user.product.edit',$product->id)}}">
        @csrf 
        @method('POST')
        ...
        <div class="form-group">
          ...
          <textarea name="summary"  cols="10" rows="5" class="form-control" >{{$product->summary}}</textarea>
          @error('summary')
          <span class="text-danger">{{$message}}</span>
          @enderror
        </div>
        ...
        <div class="form-group">
          ...
          <textarea name="description"  cols="10" rows="5" class="form-control" >{{$product->description}}</textarea>
          @error('description')
          <span class="text-danger">{{$message}}</span>
          @enderror
        </div>
